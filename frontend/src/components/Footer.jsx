...
const Footer = () => {
  return (
    <Box mt={5} className='footer' >
      ...
      >
        <Text colorScheme='blackAlpha' fontSize={20} p={5} >Made by <a href='https://github.com/krantikharat91' rel='noreferrer' target='_blank' ><i>Kranti Ramdas Kharat</i></a></Text>
      </Box>
    </Box>
  )
}
